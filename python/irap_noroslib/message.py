"""Message types for irap_noroslib.

A message type is nothing but its ROS `.msg` text. Register it and irap_noroslib derives
...
Define your own type in one call::
    ...
    from irap_noroslib.message import define_message
